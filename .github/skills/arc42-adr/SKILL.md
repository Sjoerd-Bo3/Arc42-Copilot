---
name: arc42-adr
description: Create or update Architecture Decision Records (ADRs) for arc42 Chapter 9 with proper context, alternatives, and consequences.
argument-hint: "decision topic (e.g. 'use PostgreSQL over MongoDB')"
---

# Arc42 ADR Writer

Help document architecture decisions as ADRs.
...
Use ✅ for benefits and ⚠️ for risks/downsides.
